...
// 当条件不满足新前<=新后&&旧前<=旧后，循环结束 
// 如果是新节点先循环完毕说明旧节点中有需要删除的节点，旧前和旧后指针之间的节点即为要删除的节点
// 如果是旧节点先循环完毕说明新结点中有需要插入的节点，新前和新后指针之间的节点即为要插入的节点，插入到oldCh[oldStartIdx]（旧节点中的第一个未处理节点）之前
